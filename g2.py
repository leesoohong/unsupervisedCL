...
class simclr(nn.Module):
  ...
  def loss_cal(self, x, x_aug,alpha):
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs+1):
        ...
        for data in dataloader:
            ...
            # print(x)
            # print(x_aug)
            loss = model.loss_cal(x, x_aug,args.alpha)
            print(loss)
    ...
    with open('logs2/log_' + args.DS + '_' + args.aug+args.alphga, 'a+') as f:
