...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs+1):
        ...
        for data in dataloader:
            ...
            sim_matrix_t=m(sim_matrix_t)
            loss_consis=1/2*torch.nn.functional.kl_div(sim_matrix,sim_matrix_t,reduction='sum')+1/2*torch.nn.functional.kl_div(sim_matrix_t,sim_matrix,reduction='sum')
            loss=-loss_consis*args.alpha
    ...
    alpha=args.alpha
    alpha=str(alpha)
    log_path='logs2/log_' + args.DS + '_' + args.aug+"_"+str(args.alpha)
